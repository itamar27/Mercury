...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nominee', models.CharField(blank=True, max_length=255)),
                ('round', models.SmallIntegerField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game_appearance', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='research.gameappearance')),
                ('votes', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='research.vote')),
            ],
        ),
    ]
